...
public class BattleshipWeek3Tests {
	...
	public void testGermanLabelText() {
		assertEquals("Tragen Sie Ihre Brettgröße ein: (Breite, Höhe) ", germanBundle.getString("enterBoardSize"));
	...
	public void testGermanMenuText() {
		...
		assertEquals("Ändern Sie die Sprache der Anwendung zu Englisch", germanBundle.getString("changeToEnglish"));
		assertEquals("Deutsch", germanBundle.getString("german"));
		assertEquals("Ändern Sie die Sprache der Anwendung zum Deutschen", germanBundle.getString("changeToGerman"));
